...
public class AsiaFoodAdapter extends RecyclerView.Adapter<AsiaFoodAdapter.AsiaFoodViewHolder> {
    ...
    Context context;
    List<Food> asiaFoodList;



    public AsiaFoodAdapter(Context context, List<Food> asiaFoodList) {
    ...
    public static final class AsiaFoodViewHolder extends RecyclerView.ViewHolder{
        ...
        public AsiaFoodViewHolder(@NonNull View itemView) {
            ...
            foodImage = itemView.findViewById(R.id.imagePopular);
            price = itemView.findViewById(R.id.pricePopular);
            name = itemView.findViewById(R.id.namePopular);
